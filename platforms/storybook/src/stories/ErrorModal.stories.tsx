import ErrorModal, { ErrorModalProps } from '@shared/components/ErrorModal';
import { toValidationError } from '@shared/errors/ValidationError';
import { Meta, Story } from '@storybook/react';
import { Supporter } from '@yttrex/shared/src/models/Supporter';
...
export const ValidationErrorModal = Template.bind({});
ValidationErrorModal.args = pipe(
  Supporter.decode({
    name: 'Mario',
    lastName: 'Rossi',
  }),
  E.mapLeft((e) => toValidationError('Supporter does not match', e)),
  E.fold(
    (e) => {
      return {
        name: e.name,
