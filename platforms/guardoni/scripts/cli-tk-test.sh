...
# ./dist/guardoni-cli-$version-linux --verbose --basePath ./ tk-navigate

#register an experiment for search
tk_search_experiment_register_out="$(./dist/guardoni-cli-$version-linux --verbose --basePath ./ tk-register ./experiments/tk-search.csv | grep 'experimentId:')"
tk_search_experiment_id=${tk_search_experiment_register_out/'experimentId: '/''}

# echo $tk_search_experiment_id

# exec the experiment
tk_search_experiment_run_out=$(./dist/guardoni-cli-$version-linux --verbose --headless --basePath ./ tk-experiment $tk_search_experiment_id |  grep 'publicKey:')
...
tk_video_experiment_register_out="$(./dist/guardoni-cli-$version-linux --verbose --basePath ./ tk-register ./experiments/tk-videos.csv | grep 'experimentId:')"
tk_video_experiment_id=${tk_video_experiment_register_out/'experimentId: '/''}

# echo $tk_video_experiment_id

# exec the experiment
tk_video_experiment_run_out=$(./dist/guardoni-cli-$version-linux --verbose --headless --basePath ./ tk-experiment $tk_video_experiment_id |  grep 'publicKey:')
