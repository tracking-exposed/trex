...
describe("The Public API", () => {
  ...
  describe("Get Content Creator Related Channels", () => {
    ...
    it("returns results related to the channelId by amount and skip", async () => {
      ...
      expect(firstResponse.body.totalRecommendations).toBe(totalRelatedChannels);
      ...
      expect(secondResponse.body.totalRecommendations).toBe(totalRelatedChannels);
      ...
      expect(thirdResponse.body.totalRecommendations).toBe(totalRelatedChannels);
