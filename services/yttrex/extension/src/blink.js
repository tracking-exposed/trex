...
<div>
    ...
    <p style="font-size: 1.2rem">You can see the nearby icons <span>${logo(
      ...
      '10px',
      '#bbb'
    )}</span> and they blink. Each position/color is a different stage in the evidence collection.</p>
    <br /><br />
    <ul style="list-style-type: none;">
        <li style="font-size: 1.2rem">${logo(
          ...
          '15px',
          '#00aefe'
        )} URL ignored as not part of the data processing policy.</li>
        <li style="font-size: 1.2rem">${logo(
          '15px',
          '15px',
          '#269072'
        )} Content processed</li>
        <li style="font-size: 1.2rem">${logo(
          '15px',
          '15px',
          '#c03030'
        )} Evidence sent to the server; <a href="${config.WEB_ROOT}/personal/#${
      config.publicKey
    }" target=_blank><b>A</b>ccess your data</a>.</li>
        <li style="font-size: 1.2rem">${logo(
          '15px',
          '15px',
          '#ffb545'
