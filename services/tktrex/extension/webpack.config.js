...
var ENV_DEP_SERVER = DEVELOPMENT ? ('http://' + DEV_SERVER + ':14000') : 'https://tiktok.tracking.exposed';
var ENV_DEP_WEB = DEVELOPMENT ? ('http://' + DEV_SERVER + ':1313') : 'https://tiktotk.tracking.exposed';
...
const DEV_PLUGINS = [
    new WebpackNotifierPlugin({
        ...
        urgency: 'critical',
        title: 'tktrex',
        contentImage: path.join(__dirname, 'icons', 'tktrex128.png'),
        timeout: 2,
        alwaysNotify: true
    })
];
